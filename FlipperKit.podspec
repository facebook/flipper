...
Pod::Spec.new do |spec|
  ...
  spec.subspec "Core" do |ss|
    ...
    ss.dependency 'Flipper', '~>'+flipperkit_version
    ss.compiler_flags = folly_compiler_flags
    ss.source_files = 'iOS/FlipperKit/*.{h,m,mm}', 'iOS/FlipperKit/CppBridge/*.{h,mm}', 'iOS/FBDefines/FBDefines.h'
    ss.public_header_files = 'iOS/FBDefines/FBDefines.h', 'iOS/FlipperKit/**/{FlipperDiagnosticsViewController,FlipperStateUpdateListener,FlipperClient,FlipperPlugin,FlipperConnection,FlipperResponder,SKMacros}.h'
