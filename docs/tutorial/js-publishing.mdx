...
To read more details on how marketplace works and how it can be integrated, please read this document: <Link to={useBaseUrl('/docs/tutorial/marketplace')}>Marketplace</Link>.
