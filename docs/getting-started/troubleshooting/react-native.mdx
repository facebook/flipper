...
1. Ensure that your device is set to the correct time and time zone for TLS verification to work.
2. Remove the old certificates (mv ~/.flipper/certs ~/.flipper/certs.old)                            
