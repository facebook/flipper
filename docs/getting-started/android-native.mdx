...
dependencies {
  debugImplementation 'com.facebook.flipper:flipper:0.179.0'
  debugImplementation 'com.facebook.soloader:soloader:0.10.4'

  releaseImplementation 'com.facebook.flipper:flipper-noop:0.179.0'
}
```
...
dependencies {
  debugImplementation 'com.facebook.flipper:flipper:0.179.1-SNAPSHOT'
  debugImplementation 'com.facebook.soloader:soloader:0.10.4'

  releaseImplementation 'com.facebook.flipper:flipper-noop:0.179.1-SNAPSHOT'
}
```
