...
dependencies {
  ...
  releaseImplementation 'com.facebook.flipper:flipper-noop:0.192.0'
}
```
...
dependencies {
  debugImplementation 'com.facebook.flipper:flipper:0.191.2-SNAPSHOT'
  debugImplementation 'com.facebook.soloader:soloader:0.10.5'

  releaseImplementation 'com.facebook.flipper:flipper-noop:0.191.2-SNAPSHOT'
}
```
