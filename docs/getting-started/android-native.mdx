...
dependencies {
  ...
  releaseImplementation 'com.facebook.flipper:flipper-noop:0.91.2'
}
```
...
dependencies {
  debugImplementation 'com.facebook.flipper:flipper:0.91.3-SNAPSHOT'
  debugImplementation 'com.facebook.soloader:soloader:0.10.1'

  releaseImplementation 'com.facebook.flipper:flipper-noop:0.91.3-SNAPSHOT'
}
```
