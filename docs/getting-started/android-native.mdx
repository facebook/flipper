...
dependencies {
  debugImplementation 'com.facebook.flipper:flipper:0.267.0'
  debugImplementation 'com.facebook.soloader:soloader:0.10.5'

  releaseImplementation 'com.facebook.flipper:flipper-noop:0.267.0'
}
```
...
dependencies {
  debugImplementation 'com.facebook.flipper:flipper:0.266.1-SNAPSHOT'
  debugImplementation 'com.facebook.soloader:soloader:0.10.5'

  releaseImplementation 'com.facebook.flipper:flipper-noop:0.266.1-SNAPSHOT'
}
```
