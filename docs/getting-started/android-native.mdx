...
dependencies {
  ...
  releaseImplementation 'com.facebook.flipper:flipper-noop:0.147.1'
}
```
...
dependencies {
  debugImplementation 'com.facebook.flipper:flipper:0.147.2-SNAPSHOT'
  debugImplementation 'com.facebook.soloader:soloader:0.10.1'

  releaseImplementation 'com.facebook.flipper:flipper-noop:0.147.2-SNAPSHOT'
}
```
