...
dependencies {
  debugImplementation 'com.facebook.flipper:flipper:0.114.0'
  debugImplementation 'com.facebook.soloader:soloader:0.10.1'

  releaseImplementation 'com.facebook.flipper:flipper-noop:0.114.0'
}
```
...
dependencies {
  debugImplementation 'com.facebook.flipper:flipper:0.113.1-SNAPSHOT'
  debugImplementation 'com.facebook.soloader:soloader:0.10.1'

  releaseImplementation 'com.facebook.flipper:flipper-noop:0.113.1-SNAPSHOT'
}
```
