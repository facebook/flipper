...
dependencies {
  debugImplementation 'com.facebook.flipper:flipper:0.40.0'
  debugImplementation 'com.facebook.soloader:soloader:0.9.0'

  releaseImplementation 'com.facebook.flipper:flipper-noop:0.40.0'
}
```
...
dependencies {
  debugImplementation 'com.facebook.flipper:flipper:0.40.1-SNAPSHOT'
  debugImplementation 'com.facebook.soloader:soloader:0.9.0'

  releaseImplementation 'com.facebook.flipper:flipper-noop:0.40.1-SNAPSHOT'
}
```
