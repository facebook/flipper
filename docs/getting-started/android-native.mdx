...
dependencies {
  ...
  releaseImplementation 'com.facebook.flipper:flipper-noop:0.103.0'
}
```
...
dependencies {
  debugImplementation 'com.facebook.flipper:flipper:0.102.1-SNAPSHOT'
  debugImplementation 'com.facebook.soloader:soloader:0.10.1'

  releaseImplementation 'com.facebook.flipper:flipper-noop:0.102.1-SNAPSHOT'
}
```
