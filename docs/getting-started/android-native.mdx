...
dependencies {
  ...
  releaseImplementation 'com.facebook.flipper:flipper-noop:0.126.0'
}
```
...
dependencies {
  debugImplementation 'com.facebook.flipper:flipper:0.125.1-SNAPSHOT'
  debugImplementation 'com.facebook.soloader:soloader:0.10.1'

  releaseImplementation 'com.facebook.flipper:flipper-noop:0.125.1-SNAPSHOT'
}
```
