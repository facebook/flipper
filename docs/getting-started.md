...
dependencies {
  debugImplementation 'com.facebook.flipper:flipper:0.33.0'
  debugImplementation 'com.facebook.soloader:soloader:0.8.2'

  releaseImplementation 'com.facebook.flipper:flipper-noop:0.33.0'
}
```
...
dependencies {
  debugImplementation 'com.facebook.flipper:flipper:0.32.3-SNAPSHOT'
  debugImplementation 'com.facebook.soloader:soloader:0.8.2'

  releaseImplementation 'com.facebook.flipper:flipper-noop:0.32.3-SNAPSHOT'
}
```
