...
dependencies {
  debugImplementation 'com.facebook.flipper:flipper:0.29.1'
  debugImplementation 'com.facebook.soloader:soloader:0.5.1'

  releaseImplementation 'com.facebook.flipper:flipper-noop:0.29.1'
}
```
...
dependencies {
  debugImplementation 'com.facebook.flipper:flipper:0.29.2-SNAPSHOT'
  debugImplementation 'com.facebook.soloader:soloader:0.5.1'

  releaseImplementation 'com.facebook.flipper:flipper-noop:0.29.2-SNAPSHOT'
}
```
