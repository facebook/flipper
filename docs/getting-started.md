...
dependencies {
  debugImplementation 'com.facebook.flipper:flipper:0.24.0'
  debugImplementation 'com.facebook.soloader:soloader:0.5.1'

  releaseImplementation 'com.facebook.flipper:flipper-noop:0.24.0'
}
```
...
dependencies {
  debugImplementation 'com.facebook.flipper:flipper:0.24.1-SNAPSHOT'
  debugImplementation 'com.facebook.soloader:soloader:0.5.1'

  releaseImplementation 'com.facebook.flipper:flipper-noop:0.24.1-SNAPSHOT'
}
```
