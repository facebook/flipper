...
dependencies {
  debugImplementation 'com.facebook.flipper:flipper:0.29.5-SNAPSHOT'
  debugImplementation 'com.facebook.soloader:soloader:0.5.1'

  releaseImplementation 'com.facebook.flipper:flipper-noop:0.29.5-SNAPSHOT'
}
```
