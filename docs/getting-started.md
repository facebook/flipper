...
dependencies {
  debugImplementation 'com.facebook.flipper:flipper:0.29.3'
  debugImplementation 'com.facebook.soloader:soloader:0.5.1'

  releaseImplementation 'com.facebook.flipper:flipper-noop:0.29.3'
}
```
...
dependencies {
  debugImplementation 'com.facebook.flipper:flipper:0.29.4-SNAPSHOT'
  debugImplementation 'com.facebook.soloader:soloader:0.5.1'

  releaseImplementation 'com.facebook.flipper:flipper-noop:0.29.4-SNAPSHOT'
}
```
