...
dependencies {
  debugImplementation 'com.facebook.flipper:flipper:0.215.1'
  debugImplementation 'com.facebook.soloader:soloader:0.10.5'

  releaseImplementation 'com.facebook.flipper:flipper-noop:0.215.1'
}
```
...
dependencies {
  debugImplementation 'com.facebook.flipper:flipper:0.215.2-SNAPSHOT'
  debugImplementation 'com.facebook.soloader:soloader:0.10.5'

  releaseImplementation 'com.facebook.flipper:flipper-noop:0.215.2-SNAPSHOT'
}
```
