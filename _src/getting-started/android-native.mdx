...
dependencies {
  debugImplementation 'com.facebook.flipper:flipper:0.128.3'
  debugImplementation 'com.facebook.soloader:soloader:0.10.1'

  releaseImplementation 'com.facebook.flipper:flipper-noop:0.128.3'
}
```
...
dependencies {
  debugImplementation 'com.facebook.flipper:flipper:0.128.4-SNAPSHOT'
  debugImplementation 'com.facebook.soloader:soloader:0.10.1'

  releaseImplementation 'com.facebook.flipper:flipper-noop:0.128.4-SNAPSHOT'
}
```
