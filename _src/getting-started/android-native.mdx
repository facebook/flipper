...
dependencies {
  ...
  releaseImplementation 'com.facebook.flipper:flipper-noop:0.213.0'
}
```
...
dependencies {
  debugImplementation 'com.facebook.flipper:flipper:0.213.1-SNAPSHOT'
  debugImplementation 'com.facebook.soloader:soloader:0.10.5'

  releaseImplementation 'com.facebook.flipper:flipper-noop:0.213.1-SNAPSHOT'
}
```
