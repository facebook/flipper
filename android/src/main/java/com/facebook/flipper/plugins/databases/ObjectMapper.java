...
public class ObjectMapper {
    ...
    public static FlipperArray databaseListToFlipperArray(Collection<DatabaseDescriptorHolder> databaseDescriptorHolderList) {
        FlipperArray.Builder builder = new FlipperArray.Builder();

        for (DatabaseDescriptorHolder databaseDescriptorHolder : databaseDescriptorHolderList) {

            List<String> tableNameList = databaseDescriptorHolder.databaseDriver.getTableNames(databaseDescriptorHolder.databaseDescriptor);
    ...
    public static GetTableStructureRequest flipperObjectToGetTableStructureRequest(FlipperObject params) {
        int databaseId = params.getInt("databaseId");
        String table = params.getString("table");
        if (databaseId <= 0 || TextUtils.isEmpty(table)) {
            return null;
    ...
    public static FlipperObject databaseGetTableDataReponseToFlipperObject(DatabaseGetTableDataResponse databaseGetTableDataResponse) {
        ...
        for (List<Object> row : databaseGetTableDataResponse.values) {
            ...
            for (Object item : row) {
                valueBuilder.put(
                    objectAndTypeToFlipperObject(item)
                );
            }
    ...
    public static FlipperObject databaseGetTableStructureReponseToFlipperObject(DatabaseGetTableStructureResponse databaseGetTableStructureResponse) {
    ...
    public static FlipperObject databaseExecuteSqlResponseToFlipperObject(DatabaseExecuteSqlResponse databaseExecuteSqlResponse) {
