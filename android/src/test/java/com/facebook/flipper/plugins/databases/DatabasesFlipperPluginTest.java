...
public class DatabasesFlipperPluginTest {
    ...
    public void setUp() {
        ...
        databaseHelper1 = new DatabaseHelper(ApplicationProvider.getApplicationContext(), "database1.db");
        databaseHelper1.getWritableDatabase().execSQL("INSERT INTO first_table (column1, column2) VALUES('a','b')");
        databaseHelper2 = new DatabaseHelper(ApplicationProvider.getApplicationContext(), "database2.db");
        databaseHelper2.getWritableDatabase().execSQL("INSERT INTO first_table (column1, column2) VALUES('a','b')");
        plugin = new DatabasesFlipperPlugin(
                ...
                new SqliteDatabaseProvider() {
                    ...
                    public List<File> getDatabaseFiles() {
                        return Arrays.asList(
                            ApplicationProvider.getApplicationContext().getDatabasePath(databaseHelper1.getDatabaseName()),
                            ApplicationProvider.getApplicationContext().getDatabasePath(databaseHelper2.getDatabaseName())
                        );
                    }
                }
            )
    ...
    public void testCommandDatabaseList() throws Exception {
        ...
        // Assert
        assertThat(responderMock.successes, hasItem(
    ...
    public void testCommandGetTableDataInvalidParams() throws Exception {
        ...
        // Act
        connectionMock.receivers.get("getTableData").onReceive(
            new FlipperObject.Builder()
        ...
        // Assert
        assertThat(responderMock.errors, hasItem(
            new FlipperObject.Builder()
    ...
    public void testCommandGetTableStructure() throws Exception {
        ...
        // Act
        connectionMock.receivers.get("getTableStructure").onReceive(
            new FlipperObject.Builder()
                .put("databaseId", 1)
                .put("table", "first_table")
                .build(),
        ...
        assertThat(responderMock.successes, hasItem(
            new FlipperObject.Builder()
                ...
                .put("definition", "CREATE TABLE first_table (_id INTEGER PRIMARY KEY AUTOINCREMENT,column1 TEXT,column2 TEXT)")
                .build()
            )
        );
    }
    ...
    public void testCommandExecuteInvalidParams() throws Exception {
        ...
        // Act
        connectionMock.receivers.get("execute").onReceive(
            new FlipperObject.Builder()
                .put("databaseId", 1)
